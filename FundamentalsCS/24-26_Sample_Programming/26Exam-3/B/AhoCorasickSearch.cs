...
namespace FundamentalsCS._24_26_Sample_Programming._26Exam_3.B
{
    ...
    public class AhoCorasickSearch
    {
        ...
        public string Replace(string text, string newWord)
        {
            ...
            var result = this.SearchAll(text, 0);
        ...
        private object SearchAll(string text, object start)
        {
        ...
        /// <returns></returns>
        public virtual SearchResult[] SearchAll(string text, string[] wordLowercase)
        {
